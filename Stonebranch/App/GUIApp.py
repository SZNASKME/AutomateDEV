...
class App(ctk.CTk):
    ...
    # def setupPageSwitch(self):
    #     # Page Switch Frame
    #     self.page_switch_frame = ctk.CTkFrame(self)
    #     self.page_switch_frame.grid(row=0, column=0, sticky="nsew", padx=10, pady=10)
    #     self.page_switch_frame.grid_columnconfigure(0, weight=1)

    #     # Page Switch Dropdown
    #     self.page_switch_var = tk.StringVar(value="Home")
    #     self.page_switch_dropdown = ctk.CTkOptionMenu(
    #         self.page_switch_frame, values=["Home", "Settings", "About"], variable=self.page_switch_var
    #     )
    #     self.page_switch_dropdown.grid(row=0, column=0, padx=10, pady=10, sticky="ew")
    #     self.page_switch_dropdown.bind("<<OptionMenuSelected>>", self.switchPage)

        
    # def switchPage(self, event):
    #     selected_page = self.page_switch_var.get()
